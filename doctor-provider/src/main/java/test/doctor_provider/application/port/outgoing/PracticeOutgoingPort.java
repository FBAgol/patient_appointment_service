...
public interface PracticeOutgoingPort {
     ...
     *
     * @param cityId Optional: Filter nach Stadt-ID
     * @param practiceName Optional: Filter nach Praxis-Name (Teilstring-Suche)
     ...
     *
     * Wird verwendet für:
     * - Validierungen bei Doctor.practiceId
     * - PUT/DELETE Operationen (Existenz-Prüfung)
     *
     * @param id UUID der Praxis
     ...
     *
     * @param practice Zu speichernde Praxis (ohne ID)
     ...
     *
     * @param practice Zu aktualisierende Praxis (mit ID)
     ...
     *
     * @param id UUID der zu löschenden Praxis
     */
     ...
     *
     * Verwendung:
     * - Validierung bei Doctor.practiceId
     * - Validierung vor PUT/DELETE
     *
     * @param id UUID der Praxis
     ...
     *
     * Verwendung:
     * - Unique-Constraint-Prüfung bei POST /api/v1/practice
     * - Konflikt-Prüfung bei PUT /api/v1/practice/{id}
     * - Verhindert Duplikate (409 Conflict)
     *
     * @param name Name der Praxis (case-sensitive oder case-insensitive je nach DB-Config)
     * @return true wenn Praxis mit diesem Namen existiert
     */
    boolean existsByName(String name);

    /**
     * Prüft, ob eine andere Praxis (außer der mit gegebener ID) den Namen bereits verwendet.
     *
     * Verwendung bei PUT:
     * - Prüfe ob neuer Name bereits von ANDERER Praxis verwendet wird
     * - Erlaubt: Praxis behält ihren eigenen Namen
     * - Verhindert: Praxis nimmt Namen einer anderen Praxis (409 Conflict)
     *
     * @param name Name der Praxis
     * @param excludeId ID der Praxis, die ausgeschlossen werden soll (die gerade aktualisiert wird)
