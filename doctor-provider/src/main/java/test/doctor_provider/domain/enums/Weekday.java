...
public enum Weekday {
     ...
     *
     * @param value Zahl zwischen 1 und 7
     * @return Weekday Enum
     * @throws IllegalArgumentException wenn value nicht zwischen 1-7 liegt
     */
    public static Weekday fromValue(int value) {
        ...
        throw new IllegalArgumentException(
            "Invalid weekday value: " + value + ". Must be between 1 and 7."
        );
    }
}
