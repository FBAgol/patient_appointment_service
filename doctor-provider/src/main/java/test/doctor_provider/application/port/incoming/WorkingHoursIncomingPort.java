...
/**
 * Inbound Port für Working Hours Operationen. Definiert die Business-Use-Cases
 * für Arbeitszeiten von Ärzten.
 */
public interface WorkingHoursIncomingPort {
	 ...
	 *            UUID des Arztes
	 * @param workingHours
	 *            Domain-Modell der zu erstellenden Working Hours (ohne ID)
