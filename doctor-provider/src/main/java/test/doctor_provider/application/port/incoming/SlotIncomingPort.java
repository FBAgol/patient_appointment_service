...
/**
 * Inbound Port für Slot-Operationen.
 * Definiert die Business-Use-Cases für Termin-Slots.
 */
public interface SlotIncomingPort {

    /**
     * Gibt alle Slots zurück, optional gefiltert nach Suchkriterien.
     * Alle Filter-Parameter sind optional.
     *
     * Entspricht: GET /api/v1/slots (operationId: findSlots)
     *
     * @param doctorId Filter nach Arzt-ID
