...
public interface CityIncomingPort {
     ...
     *
     * @param name Optional: Filter nach Stadt-Name
     * @param postalCode Optional: Filter nach Postleitzahl
     * @param page Seitennummer (0-basiert, Pflicht)
     * @param size Anzahl Elemente pro Seite (Pflicht)
