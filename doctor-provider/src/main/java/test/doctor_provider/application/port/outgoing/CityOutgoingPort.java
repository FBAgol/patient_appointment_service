...
public interface CityOutgoingPort {
     ...
     *
     * @param name Optional: Filter nach Stadt-Name (Teilstring-Suche, case-insensitive)
     * @param postalCode Optional: Filter nach Postleitzahl (Teilstring-Suche)
     ...
     *
     * Wird z.B. verwendet für Validierungen:
     * - Beim Anlegen einer Practice: Existiert die cityId?
     * - Beim Filtern von Doctors: Ist die cityId gültig?
     *
     * @param id UUID der Stadt
     ...
     *
     * Verwendung:
     * - Validierung bei Practice.cityId
     * - Validierung bei Filtern (z.B. GET /api/v1/doctors?cityId=...)
     *
     * @param id UUID der Stadt
