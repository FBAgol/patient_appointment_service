...
public interface SpecialityOutgoingPort {
     ...
     * - Validierung bei Doctor.specialityIds
     * - Anzeige von Details zu einer Fachrichtung
     *
     * @param id UUID der Fachrichtung
     ...
     *
     * Wird verwendet bei:
     * - Doctor hat Set<UUID> specialityIds → Lade alle zugehörigen Specialities
     * - Bulk-Validierung: Existieren alle IDs?
     *
     * @param ids Set von UUIDs
     * @return Liste von gefundenen Fachrichtungen (kann kleiner sein als ids.size() wenn einige nicht existieren)
     */
     ...
     * Verwendung:
     * - Validierung bei Doctor.specialityIds
     * - Validierung bei Filtern (z.B. GET /api/v1/doctors?specialityId=...)
     *
     * @param id UUID der Fachrichtung
     ...
     *
     * Verwendung:
     * - Validierung bei Doctor-Erstellung: Existieren alle specialityIds?
     * - Bulk-Validierung
     *
     * @param ids Set von UUIDs zu prüfen
