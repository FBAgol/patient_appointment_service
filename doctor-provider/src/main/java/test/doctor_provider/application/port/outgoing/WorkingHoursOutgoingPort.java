...
public interface WorkingHoursOutgoingPort {
     ...
     *
     * ⚠️ Hinweis: Slots werden automatisch generiert (in einem separaten Use-Case/Service)
     *
     * @param workingHours Zu speichernde Working Hours (ohne ID, aber mit doctorId)
     ...
     *
     * @param id UUID der Working Hours
     ...
     *
     * @param workingHours Zu aktualisierende Working Hours (mit ID)
     ...
     *
     * ⚠️ Wichtig: Zugehörige Slots sollten ebenfalls gelöscht werden (CASCADE oder manuell)
     *
     ...
     * - Validierung vor Slot-Generierung
     *
     * @param id UUID der Working Hours
    ...
    /**
     * Prüft, ob es eine Zeitüberlappung für einen Arzt an einem bestimmten Wochentag gibt.
     *
     * Verwendung bei POST/PUT:
     * - Verhindert überlappende Working Hours (409 Conflict)
     * - Beispiel: Arzt hat bereits 08:00-12:00 am Montag → 10:00-14:00 würde überlappen
     *
     * ⚠️ Wichtig: Beim UPDATE muss die eigene ID ausgeschlossen werden!
     *
     * @param doctorId UUID des Arztes
     * @param weekday Wochentag (MONDAY, TUESDAY, etc.)
     * @param startTime Startzeit der neuen/zu ändernden Working Hour
     * @param endTime Endzeit der neuen/zu ändernden Working Hour
     * @param excludeId Optional: ID auszuschließen (bei UPDATE die eigene ID)
