...
public class SlotEntity {
     ...
     *
     * WICHTIG:
     * - ZonedDateTime für TIMESTAMP WITH TIME ZONE in PostgreSQL
     * - Speichert Datum, Zeit UND Timezone
     * - Beispiel: 2026-02-12T10:00:00+01:00[Europe/Berlin]
     */
     ...
     *
     * WICHTIG:
     * - PostgreSQL ENUM-Typ: slot_status
     * - Java Enum: SlotStatus
     * - Werte: available, booked, blocked
     */
     ...
     *
     * WICHTIG:
     * - Slots gehören zu Working Hours (nicht direkt zu Doctor!)
     * - Doctor wird über workingHours.doctor ermittelt
     * - CASCADE DELETE: Wenn Working Hours gelöscht wird, werden alle Slots gelöscht
     */
