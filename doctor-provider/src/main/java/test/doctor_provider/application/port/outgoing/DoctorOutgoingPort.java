...
public interface DoctorOutgoingPort {
     ...
     *
     * ⚠️ cityId-Filter: Benötigt JOIN zu practice Tabelle
     * SELECT d.* FROM doctor d
     * JOIN practice p ON d.practice_id = p.id
     * WHERE p.city_id = ?
     *
     ...
     * @param cityId Filter nach Stadt-ID (benötigt JOIN zu practice)
     * @param specialityId Filter nach Fachrichtung-ID (benötigt JOIN zu doctor_speciality)
     ...
     * - Anzeige von Arzt-Details
     *
     * @param id UUID des Arztes
     ...
     *
     * @param doctor Zu speichernder Arzt (ohne ID)
     ...
     *
     * @param doctor Zu aktualisierender Arzt (mit ID)
     ...
     *
     * @param id UUID des zu löschenden Arztes
     */
